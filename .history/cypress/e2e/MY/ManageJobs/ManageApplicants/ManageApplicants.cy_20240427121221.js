...
describe("Manage Applicants", () => {
	...
	it("Move the applicant from Shortlisted to Rejected", () => {
		JobPostPage.GoToJobListing();
		cy.get(".new-jobapp").should("be.visible");
		cy.get(":nth-child(2) > .job-stats-link").click();
	...
	it("Move the applicant from Rejected to KIV", () => {
		JobPostPage.GoToJobListing();
		cy.get(".new-jobapp").should("be.visible");
		cy.get(":nth-child(2) > .job-stats-link").click();
	...
	it("Move the applicant from KIV to Shortlisted", () => {
		JobPostPage.GoToJobListing();
		cy.get(".new-jobapp").should("be.visible");
		cy.get(":nth-child(2) > .job-stats-link").click();
	...
	it("Move the applicant from Shortlisted to Hired", () => {
		JobPostPage.GoToJobListing();
		cy.get(".new-jobapp").should("be.visible");
		cy.get(":nth-child(2) > .job-stats-link").click();
