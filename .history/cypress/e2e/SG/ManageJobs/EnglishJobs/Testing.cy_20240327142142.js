...
describe("Expire JOb", () => {
    ...
    it('Verify if job card is displayed', () => {
        ...
        // cy.get('#jobsList').find('.panel-body').should('exist')
        // cy.get('#jobsList').find('.panel-body').should('not.exist')

        cy.get('#jobsList').then(($jobAdElement) => {
            const findJobCardElement = $jobAdElement.find('.panel-body').should('exist')
