class JobPostPage {
	...
	VerifyJobFormElements = () => {
		const generalElements = [
			...
			this.elements.SubLocation,
			this.elements.WorkingPlace,
			this.elements.JobCategory,
			this.elements.JobCategoryTwo,
			this.elements.JobTypePartTime,
			this.elements.JobTypeFullTime,
			this.elements.JobTypeContracts,
			this.elements.Timing,
			this.elements.FilterApplicants,
			this.elements.ApplyByEmail,
			this.elements.ApplyByCallSms,
			this.elements.AppyByWhatsapp,
			this.elements.PostNewJobBtn,
		];
