class SGJobPostPage {
    ...
    VerifyJobPostFormElements = () => {
        ...
        // this.elements.NearestMRT().should('be.visible') // This section is not displayed when account type is outlet
        ...
        // this.elements.SetOutletsSettingBtn().should('be.visible') // This section is not displayed when account type is outlet
        ...
        // this.elements.PackageSelection().should('be.visible') // This section is not displayed when account type is Parking lot
    ...
    // Outlet
    VerifyOutletSection = () => {
        //Verify that all 3 outlets are displayed with correct name
