class UpgradePlan {
    ...
    SubmitCheckoutFormEmpty = () => {
        cy.origin("https://demo2.2c2p.com", () =>{
            ...
            this.demo2pcpElements.SubmitButton().click()

            this.demo2pcpElements.CardNumberErrorMessage().should('be.visible')
            this.demo2pcpElements.CardHolderNameErrorMessage().should('be.visible')
            this.demo2pcpElements.CardExpiryErrorMessage().should('be.visible')
            this.demo2pcpElements.CVVErrorMessage().should('be.visible')
            this.demo2pcpElements.BankNameErrorMessage().should('be.visible')
        })
    }
}
